package com.example.ruchitiwari.googleanalytics.otp;
...
import com.example.ruchitiwari.googleanalytics.otp.sms.SMSBroadcastReceiver;
import com.example.ruchitiwari.googleanalytics.otp.sms.SMSHistoryObserver;
import com.example.ruchitiwari.googleanalytics.otp.sms.SMSHistoryReader;
import com.example.ruchitiwari.googleanalytics.permission.DangerousPermResponseCallBack;
import com.example.ruchitiwari.googleanalytics.permission.DangerousPermissionResponse;
import com.example.ruchitiwari.googleanalytics.permission.DangerousPermissionUtils;
...
public class OTPReader {
    ...
    public OTPReader(Context context, String pattern, OnOTPListener listener, int timeoutInMillis) {
        ...
        if (timeoutInMillis < DEFAULT_MIN_TIMEOUT_IN_MILLIS
                && timeoutInMillis > DEFAULT_MAX_TIMEOUT_IN_MILLIS) {
